...
class DBStudentProfile extends StatefulWidget {
  ...
  DBStudentProfile({super.key, required this.id, required this.image});
...
class _DBStudentProfileState extends State<DBStudentProfile> {
  ...
  _DBStudentProfileState({required this.id, required this.image});
  ...
  late Future<StudentDetailsModel> profile;
        ...
        children: [
          Padding(
            ...
            child: Text(
              ...
              style: Theme.of(
                context,
              ).textTheme.titleSmall?.copyWith(color: const Color(0xff727fc8)),
            ),
          ),
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget getTransportList() {
    return Container(
      ...
      color: Colors.white,
      child:
          _studentDetails.studentData?.transport != null
              ? ListView(
                physics: const BouncingScrollPhysics(),
                padding: const EdgeInsets.symmetric(vertical: 30),
                children: [
  ...
  Widget getProfileHeader() {
    return Column(
      ...
      children: <Widget>[
        ...
        const SizedBox(height: 5),
        Text(
          '${'Admission'.tr} : ${_studentDetails.studentData?.userDetails?.admissionNo}',
          style: Theme.of(context).textTheme.titleLarge?.copyWith(
            color: const Color(0xFF727FC8),
            fontWeight: FontWeight.normal,
            fontSize: 12,
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(color: Color(0xFF828BB2)),
                ),
              ],
            ),
          ),
