...
class _StaffListScreenState extends State<StaffListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: 'Staff List'),
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    Text(
                      'Phone'
                      ' : ${data.staffs[index].phone}',
                      style: Theme.of(context).textTheme.headlineMedium,
                    ),
                    Text(
                      'Address'
                      ' : ${data.staffs[index].currentAddress}',
                      style: Theme.of(context).textTheme.headlineMedium,
                    ),
                  ],
                ),
