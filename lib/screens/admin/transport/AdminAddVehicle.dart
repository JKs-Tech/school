...
class _AddVehicleState extends State<AddVehicle> {
  ...
  static List<Tab> tabs = <Tab>[
    Tab(text: 'Add Vehicle'.tr),
    Tab(text: 'Vehicle List'.tr),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBarWidget(title: 'Add Vehicle'),
      body: PreferredSize(
            ...
            builder: (context) {
              ...
              return Scaffold(
                ...
                body: Padding(
                  ...
                  child: TabBarView(children: [addVehicle(), vehicleList()]),
                ),
              );
            },
          ),
          ...
          Expanded(
            child: FutureBuilder<AssignVehicleList>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  if (snapshot.data?.assignVehicle.isNotEmpty ?? false) {
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    snapshot.data?.assignVehicle[index].madeYear
                                            .toString() ??
                                        '',
                                    style:
                                        Theme.of(
          ...
          FutureBuilder<StaffList>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                return Padding(
                  padding: const EdgeInsets.only(left: 10),
                  child: getDriverDropdown(
                    context,
                    snapshot.data?.staffs ?? [],
                  ),
                );
              } else {
                return Container();
