...
class _StudentWalletTransactionsState extends State<StudentWalletTransactions> {
  final StudentWalletController _controller = Get.put(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        "Balance: ".tr +
                            (_controller.wallet.value.currencySymbol ?? '') +
                            (_controller.wallet.value.myBalance ?? ""),
        ...
        children: <Widget>[
          ...
          Obx(() {
            return DropdownButton(
              ...
              items:
                  _controller.wallet.value.paymentMethods?.map((item) {
            ...
            if (_controller.selectedPaymentMethod.value ==
              ...
              if (_controller.isBank.value) {
                return DropdownButton(
                  ...
                  items:
                      _controller.wallet.value.bankAccounts?.map((item) {
                  ...
                  onChanged: (value) {
                    _controller.selectedBank.value = value ?? BankAccount();
                  },
                  ...
                  onTap: () {
                    if (_controller.isPaymentProcessing.value) {
                      ...
                      if (_controller.selectedPaymentMethod.value == "Bank" ||
                          _controller.selectedPaymentMethod.value == "Cheque") {
