...
class VirtualClassMain extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: "Class"),
      body: Column(
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                systemController.systemSettings.value.data?.zoom ?? false
                      ...
                      children: [
                        ListTile(
                          onTap: () {
                            // pushNewScreen(
                            //   context,
                            //   screen: const ZoomVirtualClass(type: 'class'),
                            //   withNavBar: false,
                            // );
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder:
                                    (context) =>
                                        const ZoomVirtualClass(type: 'class'),
                              ),
                            );
                          },
                          title: Text(
                            ...
                            ? ListTile(
                              onTap: () {
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder:
                                        (context) => const ZoomVirtualClass(
                                          type: 'meeting',
                                        ),
                                  ),
                                );
                ...
                const SizedBox(height: 20),
                systemController.systemSettings.value.data?.bbb ?? false
                    ? CustomExpansionTileCard(
                          ...
                          onTap: () {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder:
                                    (context) =>
                                        const BBBVirtualClass(type: "class"),
                              ),
                            );
                          },
                          title: Text(
                    ...
                    : const SizedBox.shrink(),
                const SizedBox(height: 20),
                systemController.systemSettings.value.data?.jitsi ?? false
                    ? CustomExpansionTileCard(
                          ...
                          onTap: () {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder:
                                    (context) =>
                                        const JitsiVirtualClass(type: "class"),
                              ),
                            );
                          },
                          title: Text(
                            ...
                            ? ListTile(
                              onTap: () {
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder:
                                        (context) => const JitsiVirtualClass(
                                          type: "meeting",
                                        ),
                                  ),
                                );
