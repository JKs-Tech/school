...
class StudentTeacher extends StatefulWidget {
  ...
  StudentTeacher({super.key, required this.id, required this.token});
          ...
          children: [
            StudentRecordWidget(
              onTap: (Record record) async {
                ...
                setState(() {
                  teachers = getAllTeacher(mId, record.id ?? 0);
                });
              },
            ),
            Expanded(
                ...
                child: FutureBuilder<TeacherList>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      if (snapshot.hasData) {
                        if (snapshot.data?.teachers.isNotEmpty ?? false) {
