...
class TakeExamModel {
  ...
  factory TakeExamModel.fromJson(Map<String, dynamic> json) => TakeExamModel(
    ...
    onlineExamSetting: OnlineExamSetting.fromJson(json["online_exam_setting"]),
...
class ExamQuestion {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "mi_image": miImage,
    "imq_image": imqImage,
    "imq_questions": imqQuestions?.map((x) => x.toJson()).toList(),
    "mi_questions": miQuestions?.map((x) => x.toJson()).toList(),
    "m_questions": mQuestions?.map((x) => x.toJson()).toList(),
    "pi_questions": piQuestions?.map((x) => x.toJson()).toList(),
  };
}

class ImqQuestion {
  ImqQuestion({this.imqId, this.imqTitle, this.imqImageTitle});
...
class MQuestion {
  MQuestion({this.mId, this.mTitle, this.alphabet});
...
class MiQuestion {
  MiQuestion({this.miId, this.miTitle});

  int? miId;
  String? miTitle;

  factory MiQuestion.fromJson(Map<String, dynamic> json) =>
      MiQuestion(miId: json["mi_id"], miTitle: json["mi_title"]);

  Map<String, dynamic> toJson() => {"mi_id": miId, "mi_title": miTitle};
}

class PiQuestion {
  PiQuestion({this.pmId, this.pmTitle, this.pTitle});
