...
class _ScheduleScreenState extends State<ScheduleScreen> {
  ...
  late Future<ExamRoutineReport> examRoutine;
  late int examTypeId;
  var id;
  dynamic examId;
    ...
    Utils.getStringValue('id').then((value) {
      setState(() {
        ...
        examSchedule.then((val) {
          _selected =
              (val.examTypes != null && val.examTypes!.isNotEmpty)
                  ? val.examTypes![0].title
                  : '';
          examTypeId =
              (val.examTypes != null && val.examTypes!.isNotEmpty)
                  ? val.examTypes![0].id ?? 0
                  : 0;
    ...
    return Scaffold(
      ...
      body: FutureBuilder<ExamSchedule>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            if (snapshot.data?.examTypes?.isNotEmpty ?? false) {
              return Column(
                children: <Widget>[
