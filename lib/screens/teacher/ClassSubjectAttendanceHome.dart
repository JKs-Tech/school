...
class StudentSubjectAttendanceHome extends StatefulWidget {
  const StudentSubjectAttendanceHome({super.key});
...
class _StudentSubjectAttendanceHomeState
        ...
        setState(() {
          ...
          Utils.getStringValue('rule').then((ruleValue) {
            setState(() {
              rule = ruleValue;
              year = '${date?.year}';
              month = getAbsoluteDate(date?.month ?? 1);
              day = getAbsoluteDate(date?.day ?? 1);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: 'Search Attendance'),
      ...
      bottomNavigationBar: GestureDetector(
        ...
        onTap: () {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder:
                  (context) => SubjectStudentListAttendance(
                    classCode: classId,
                    sectionCode: sectionId,
                    selectedSubject: _selectedSubject,
                    subjectCode: subjectId,
  ...
  Widget getClassDropdown(List classes) {
    return Container(
      ...
      child: DropdownButton(
        ...
        style: Theme.of(
          context,
        ).textTheme.headlineMedium?.copyWith(fontSize: ScreenUtil().setSp(15)),
        onChanged: (value) {
          setState(() {
      ...
      child: DropdownButton(
        ...
        onChanged: (value) {
          setState(() {
            ...
            subjectId = getCode(subjectModellist, value.toString());
