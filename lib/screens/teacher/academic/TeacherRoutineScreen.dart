...
class TeacherMyRoutineScreen extends StatefulWidget {
  const TeacherMyRoutineScreen({super.key});
...
class _TeacherMyRoutineScreenState extends State<TeacherMyRoutineScreen> {
  ...
  Future<TeacherRoutine> getRoutine() async {
    TeacherRoutine data = TeacherRoutine(classRoutines: []);
    await Utils.getStringValue('id')
        ...
        .then((value) async {
          final response = await http.get(
            Uri.parse(
              InfixApi.routineView(_id, "teacher", recordId: _id, mine: true),
            ),
          ...
          Padding(
            ...
            child: FutureBuilder<TeacherRoutine>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  if (snapshot.data?.classRoutines?.isNotEmpty ?? false) {
