...
class _SubjectStudentListAttendanceState
  ...
  final SubjectAttendanceController _attendanceController = Get.put(
    SubjectAttendanceController(),
  );
  ...
  late Future<SubjectAttendanceList> newStudents;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _key,
      appBar: CustomAppBarWidget(title: '$selectedSubject Attendance'),
              ...
              TextButton(
                ...
                onPressed: () async {
                  ...
                  await newStudents.then((value) {
                    ...
                    _attendanceController.attendanceMap.forEach(
                      (key, value) {},
                    );
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      return ListView.builder(
                        itemCount: 5,
                        itemBuilder: (context, index) {
                          return const ShimmerList(itemCount: 1, height: 80);
                        },
                      );
                    }
                  },
  ...
  Future<SubjectAttendanceList> getAttendance() async {
    final response = await http.get(
      Uri.parse(
        InfixApi.subjectattendanceCheck(
          widget.date ?? "",
          classCode,
          sectionCode,
          subjectCode,
