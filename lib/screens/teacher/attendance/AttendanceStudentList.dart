...
class _StudentListAttendanceState extends State<StudentListAttendance> {
  ...
  late Future<AttendanceList> newStudents;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _key,
      appBar: CustomAppBarWidget(title: 'Set Attendance'),
  ...
  Future<AttendanceList> getAttendance() async {
    final response = await http.get(
      Uri.parse(InfixApi.attendanceCheck(widget.date, classCode, sectionCode)),
  ...
  Future setDefaultAttendance(Map data) async {
    ...
    final response = await http.post(
      Uri.parse(InfixApi.attendanceDefaultSent),
      headers: Utils.setHeader(token),
