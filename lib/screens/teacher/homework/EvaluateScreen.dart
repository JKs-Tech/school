...
class _EvaluateScreenState extends State<EvaluateScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: widget.studentName),
              ...
              children: [
                TextFormField(
                  ...
                  validator: (String? value) {
                    ...
                    int? totalMarks = int.tryParse(widget.totalMarks);
                    ...
                    Row(
                      ...
                      children: [
                        CustomRadioButton(
                          ...
                          buttonLables: const ['Good', 'Not Good'],
                          buttonValues: const ["G", "NG"],
