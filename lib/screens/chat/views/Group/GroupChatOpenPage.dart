...
class _GroupChatOpenPageState extends State<GroupChatOpenPage> {
  ...
  void initState() {
    ...
    source = ChatGroupLoadMore(widget.groupId,
        _chatGroupOpenController ?? ChatGroupOpenController(widget.groupId));
    ...
    if (_chatController.chatSettings.value.chatSettings?.chatMethod ==
      ...
      Future.delayed(const Duration(seconds: 3), () {
        _pusherController.chatOpenGroup(
            widget.groupId,
            source ??
                ChatGroupLoadMore(
                    widget.groupId,
                    _chatGroupOpenController ??
                        ChatGroupOpenController(widget.groupId)));
      });
    }
    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: GestureDetector(
          ...
          child: Obx(() {
            if (_chatGroupOpenController?.isLoading.value ?? false) {
                      ...
                      ? Padding(
                          ...
                          child: InkWell(
                            onTap: () {
                              ...
                              source?.deleteGroupMessage(groupThread?.id ?? 0);
                            },
                            child: Row(
                              children: [
                                Icon(
          ...
          return Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                const SizedBox(height: 10),
                _chatGroupOpenController?.members.isNotEmpty ?? false
                    ? Text(
                        "Select User",
                        style: Get.textTheme.titleMedium?.copyWith(
                          fontSize: 20,
            ...
            child: ElevatedButton.icon(
                ...
                onPressed: () {
                  ...
                  for (var element in source ?? []) {
                    if (element.conversation?.message != null &&
