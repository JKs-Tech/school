...
EdgeInsetsGeometry customPadding = const EdgeInsets.symmetric(
  horizontal: 15,
  vertical: 10,
);
                      ...
                      return DropdownButtonHideUnderline(
                        child: ButtonTheme(
                          ...
                          child: Theme(
                            data: Theme.of(
                              context,
                            ).copyWith(canvasColor: Get.theme.primaryColor),
                            child: DropdownButton(
                              ...
                              items:
                                  _chatController.chatActiveList.map((item) {
              ...
              children: [
                ...
                Expanded(
                  child: TabBarView(
                    physics: const NeverScrollableScrollPhysics(),
                    controller: tabController,
                    children: const [ChatListPage(), GroupListPage()],
                  ),
                ),
              ],
            );
                  ...
                  child: TabBarView(
                    ...
                    children: [
                      Column(
                        children: const [
                          SizedBox(height: 10),
                          Expanded(child: ChatShimmerList()),
                        ],
                      ),
                      Column(
                        children: const [
          ...
          Expanded(
            child: Obx(() {
              if (_chatController.chatModel.value.users == null) {
                ...
                if (_chatController.chatModel.value.users?.isEmpty ?? true) {
                  return Center(
                    child: Text(
                      "No users found",
                      style: Get.textTheme.titleMedium,
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Groups", style: Get.textTheme.titleMedium),
                Expanded(child: Container()),
              ],
            ),
          ),
