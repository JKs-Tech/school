...
class _ChatOpenPageState extends State<ChatOpenPage> {
  ...
  void initState() {
    ...
    source = ChatLoadMore(
      widget.userId,
      _chatOpenController ?? ChatOpenController(widget.userId),
    );
    ...
    if (_chatController.chatSettings.value.chatSettings?.chatMethod ==
      ...
      Future.delayed(const Duration(seconds: 3), () {
        _pusherController.chatOpenSingle(
          widget.userId,
          source ??
              ChatLoadMore(
                widget.userId,
  ...
  void onTriggerEventPressed() async {
    try {
      _pusherController.pusher.trigger(
        PusherEvent(
          channelName:
              'private-single-chat'
              '.${widget.userId}',
              ...
              Column(
                ...
                children: [
                          ...
                          ListConfig<ChatMessage>(
                            ...
                            itemBuilder: (
                              ...
                              return MessageItemWidget(
                                ...
                                currentUserId:
                                    _chatOpenController?.id.value.toString() ??
                                    '0',
                                menuVisible: false,
                                showActions: true,
                                activeStatus:
                            ...
                            sourceList:
                                ...
                                ChatLoadMore(
                                  widget.userId,
                                  _chatOpenController ??
                                      ChatOpenController(widget.userId),
                                ),
                          ),
                  ...
                  Container(
                    ...
                    color: Colors.white,
                    child: Obx(() {
                      if (_chatOpenController != null &&
                          _chatOpenController!.isLoading.value) {
                        return Container();
                      } else {
                        if (_chatOpenController != null &&
                            _chatOpenController!.activeUser.value.block ==
                                true) {
                          return const SizedBox.shrink();
                        } else {
                          return Column(
              ...
              children: [
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: <Widget>[
                      MessageItemWidget(
                        name: chatMessage.fromUser?.fullName ?? '',
                        avatarUrl: chatMessage.fromUser?.avatarUrl ?? '',
                        onTapMenu: () {
                          onMenuPress(
                            context: context,
                            chatMessage: chatMessage,
                        ...
                        chatMessage: chatMessage,
                        currentUserId: _chatOpenController?.id.value ?? '0',
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                timeago.format(chatMessage.createdAt ?? DateTime.now()),
                textAlign:
                    chatMessage.fromId.toString() ==
                            _chatOpenController?.id.value
                        ? TextAlign.right
                    ...
                    child: InkWell(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text("Quote", style: Get.textTheme.titleSmall),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: InkWell(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 16),
                          Text("Forward", style: Get.textTheme.titleSmall),
                        ],
                      ),
                    ),
                  ),
                        ...
                        child: InkWell(
                          ...
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 16),
                              Text("Delete", style: Get.textTheme.titleSmall),
                            ],
                          ),
                        ),
                      )
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  widget.avatarUrl == ""
                      ...
                      : CachedNetworkImage(
                        imageUrl: "${AppConfig.domainName}/${widget.avatarUrl}",
                        imageBuilder:
                            (context, imageProvider) => Container(
                              width: 35,
                              height: 35,
                            ...
                            ? Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  width: 10,
                                  decoration: BoxDecoration(
                                    color: getOnlineColor(widget.onlineStatus),
                                    shape: BoxShape.circle,
                                  ),
                                ),
                                const SizedBox(width: 5),
                  ...
                  Obx(() {
                    if (_chatOpenController?.isLoading.value ?? false) {
                      return Container();
                    } else {
...
class MessageItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        mainAxisAlignment:
            chatMessage.fromId.toString() != currentUserId
