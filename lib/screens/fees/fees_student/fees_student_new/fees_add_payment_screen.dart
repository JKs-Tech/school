...
class _FeesAddPaymentScreenState extends State<FeesAddPaymentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: 'Add Fees Payment'),
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "${'Due Date'.tr}: ${DateFormat.yMMMd().format(_controller.addPaymentModel.value.invoiceInfo?.dueDate ?? DateTime.now())}",
                              maxLines: 1,
                              style: Theme.of(context).textTheme.headlineMedium
                                  ?.copyWith(fontWeight: FontWeight.w500),
                            ),
                    ...
                    Obx(() {
                      return DropdownButton(
                        ...
                        items:
                            _controller.addPaymentModel.value.paymentMethods
                                ?.map((item) {
                    ...
                    Obx(() {
                      if (_controller.isBank.value) {
                        return DropdownButton(
                          ...
                          items:
                              _controller.addPaymentModel.value.bankAccounts?.map((
                                item,
                              ) {
