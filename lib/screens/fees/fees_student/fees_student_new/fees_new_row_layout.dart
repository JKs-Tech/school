...
class FeesRowNew extends StatefulWidget {
  ...
  FeesRowNew(this.fee, this.id, {super.key});
            ...
            PopupMenuButton(
              ...
              itemBuilder: (context) {
                if (widget.fee.status == 'paid') {
                  return [PopupMenuItem(value: 'view', child: Text('View'.tr))];
                } else {
                  return [
              ...
              onSelected: (String value) async {
                if (value == 'view') {
                  Get.to(
                    () => FeeInvoiceViewStudent(invoiceId: widget.fee.id ?? 0),
                  );
                } else {
                  Get.to(
                    () => FeesAddPaymentScreen(
                      invoiceId: widget.fee.id ?? 0,
                      updateData: () {
                        setState(() {});
                      },
                    ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        widget.fee.balance != null && widget.fee.balance! > 0
                            ? GestureDetector(
                              onTap: () {
