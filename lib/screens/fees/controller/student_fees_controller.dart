                ...
                if (selectedPaymentMethod.value == "PayPal") {
                  ...
                  Get.to(
                    () => KhaltiInvoicePayment(
                      email: "${data['email']}",
                      transactionId: "${data['transcationId']}",
  ...
  Future<StudentAddPaymentModel> getFeesInvoice(invoiceId) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (addPaymentModel.value.bankAccounts?.isNotEmpty ?? false) {
          selectedBank.value =
        ...
        addPaymentModel.value.paymentMethods?.insert(
          0,
          FeesPaymentMethod(paymentMethod: "Select Payment Method".tr),
        );
