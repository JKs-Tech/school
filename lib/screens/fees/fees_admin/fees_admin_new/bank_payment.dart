...
class _FeeBankPaymentSearchState extends State<FeeBankPaymentSearch> {
  ...
  final List<String> _statusList = ['pending', 'approve', 'reject'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: 'Fees Bank Payment'),
                ...
                FutureBuilder<FeeBankPaymentModel>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      if (snapshot.hasData) {
                        if (snapshot.data?.feesPayments?.isEmpty ?? true) {
