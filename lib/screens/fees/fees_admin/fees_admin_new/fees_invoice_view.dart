...
class FeeInvoiceDetailsView extends StatefulWidget {
  final int invoiceId;
  const FeeInvoiceDetailsView({super.key, required this.invoiceId});
  @override
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "${'Create Date'.tr}: ${DateFormat.yMMMd().format(snapshot.data?.invoiceInfo?.createDate ?? DateTime.now())}",
                            maxLines: 1,
                            style: Theme.of(context).textTheme.headlineMedium
                                ?.copyWith(fontWeight: FontWeight.w500),
                          ),
                          Text(
                            "${'Due Date'.tr}: ${DateFormat.yMMMd().format(snapshot.data?.invoiceInfo?.dueDate ?? DateTime.now())}",
                            maxLines: 1,
                            style: Theme.of(context).textTheme.headlineMedium
                                ?.copyWith(fontWeight: FontWeight.w500),
                          ),
