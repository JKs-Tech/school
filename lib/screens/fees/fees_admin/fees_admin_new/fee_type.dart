...
class _FeesTypeScreenState extends State<FeesTypeScreen> {
  ...
  Future<FeeTypeList> getFeesTypes() async {
    final response = await http.get(
      Uri.parse(InfixApi.adminFeesTypeList),
  ...
  Future<FeeGroupList> getFeesGroups() async {
    final response = await http.get(
      Uri.parse(InfixApi.adminFeeList),
      headers: Utils.setHeader(_token.toString()),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: 'Fees Type'),
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              DropdownButton(
                                ...
                                isExpanded: true,
                                items:
                                    feesGroupList.feeGroups.map((item) {
