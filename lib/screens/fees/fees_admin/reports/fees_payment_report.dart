...
class _AdminFeesPaymentReportState extends State<AdminFeesPaymentReport> {
  ...
  Future<FeePaymentReportModel> getSearchData(Map data) async {
    final response = await http.post(
      Uri.parse(InfixApi.adminFeesPaymentSearch),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: "Payment Report"),
      body: ListView(
          ...
          FutureBuilder<FeePaymentReportModel>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                if (snapshot.hasData) {
                  if (snapshot.data?.paymentReport?.isEmpty ?? true) {
