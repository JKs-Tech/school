...
class _AdminFeesDueReportState extends State<AdminFeesDueReport> {
  ...
  Future<FeesDueReportModel> getSearchData(Map data) async {
    final response = await http.post(
      Uri.parse(InfixApi.adminFeesDueSearch),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: "Due Report"),
      body: ListView(
          ...
          FutureBuilder<FeesDueReportModel>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                if (snapshot.hasData) {
                  if (snapshot.data?.feesDues?.isEmpty ?? true) {
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        FeesDue feesDue =
                            snapshot.data?.feesDues?[index] ?? FeesDue();
