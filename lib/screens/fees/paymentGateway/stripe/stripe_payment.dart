...
//       appBar: CustomAppBarWidget(title: widget.method),
//       body: Opacity(
...
//           context,
//           "Error",
//           "Payment failed. ${paymentIntentRes['status']}",
//         );
//       }
...
//     final url = Uri.parse(
//       "$postCreateIntentURL?amount=$amount&payment_method_id=$paymentMethodId&email=$email&currency=$stripeCurrency",
//     );
//     print("URL is $url");
...
//   StripeIntentResponse({required this.paymentIntent});
...
//   Map<String, dynamic> toJson() => {"paymentIntent": paymentIntent.toJson()};
// }
