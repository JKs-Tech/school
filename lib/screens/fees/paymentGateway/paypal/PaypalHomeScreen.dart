...
class PayPalPayment extends StatefulWidget {
  ...
  PayPalPayment(this.fee, this.amount, this.id, {super.key});
...
class _PayPalPaymentState extends State<PayPalPayment> {
  ...
  Widget build(BuildContext context) {
    ...
    return isCompleted ? PaymentStatusScreen(widget.fee, amount) : Container();
    // : WebviewScaffold(
    //   url: widget.apiUrl + queryParams,
    //   appBar: AppBar(title: const Text("Pay using Paypal")),
    // );
  }
...
class AddPaypalAmount extends StatelessWidget {
  ...
  AddPaypalAmount(this.fee, this.id, {super.key}) {
