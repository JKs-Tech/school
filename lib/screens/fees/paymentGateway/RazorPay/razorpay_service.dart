...
class RazorpayServices {
  ...
  onFailure(PaymentFailureResponse response, failureLitener) {
    failureLitener(
      PaymentResponse(response.message ?? "", false, response.message ?? ""),
    );
  }
  ...
  openRazorpay({
    ...
    required Function(PaymentResponse) successListener,
    required Function(PaymentResponse) failureListener,
  }) {
    ...
    try {
      ...
      debugPrint(
        failureListener(
          PaymentResponse(e.toString(), false, "Something went wrong!"),
        ),
      );
    }
  }
...
class PaymentResponse {
  ...
  PaymentResponse(this.message, this.paymentStatus, this.paymentId);
}
