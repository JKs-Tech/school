...
class _FeePaymentMainState extends State<FeePaymentMain> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: 'Select Payment Method'),
                      ...
                      child: ListTile(
                        ...
                        leading: CircleAvatar(
                          ...
                          child: SizedBox(
                            ...
                            child: Image.asset('assets/images/fees_icon.png'),
                          ),
                        ),
                        title: Text(
                          payment.method ?? '',
...
class _BankOrChequeState extends State<BankOrCheque> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: widget.paymentType),
      backgroundColor: Colors.white,
