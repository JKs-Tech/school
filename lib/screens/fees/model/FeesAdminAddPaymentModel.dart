...
class FeesAdminAddPaymentModel {
  ...
  Map<String, dynamic> toJson() => {
    "feesTypes": feesTypes != null ? List<dynamic>.from(feesTypes!.map((x) => x.toJson())) : [],
    "paymentMethods": paymentMethods != null ? List<dynamic>.from(paymentMethods!.map((x) => x.toJson())) : [],
    "bankAccounts": bankAccounts != null ? List<dynamic>.from(bankAccounts!.map((x) => x.toJson())) : [],
...
class InvoiceDetail {
  ...
  factory InvoiceDetail.fromJson(Map<String, dynamic> json) => InvoiceDetail(
    ...
    dueAmount: json["due_amount"] == null ? 0.0 : json["due_amount"].toDouble(),
...
class PaymentMethod {
  ...
  factory PaymentMethod.fromJson(Map<String, dynamic> json) =>
      PaymentMethod(method: json["method"]);
