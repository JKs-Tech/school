...
class Fee {
  Fee({this.success, this.data, this.message});
...
class Data {
  Data({this.fees, this.currencySymbol});
...
class CurrencySymbol {
  ...
  factory CurrencySymbol.fromJson(Map<String, dynamic> json) =>
      CurrencySymbol(currencySymbol: json["currency_symbol"]);

  Map<String, dynamic> toJson() => {"currency_symbol": currencySymbol};
}
