...
class FeeBankPaymentModel {
  FeeBankPaymentModel({this.feesPayments});
  ...
  Map<String, dynamic> toJson() => {
    "feesPayments":
        feesPayments != null
            ? List<dynamic>.from(feesPayments!.map((x) => x.toJson()))
            : [],
  };
}
...
class FeesPayment {
  ...
  factory FeesPayment.fromJson(Map<String, dynamic> json) => FeesPayment(
    ...
    feeStudentInfo:
        json["fee_student_info"] == null
            ? null
            : FeeStudentInfo.fromJson(json["fee_student_info"]),
    transcationDetails:
        json["transcation_details"] == null
            ? null
            : List<TranscationDetail>.from(
              json["transcation_details"].map(
                (x) => TranscationDetail.fromJson(x),
              ),
            ),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "transcation_details": List<dynamic>.from(
      transcationDetails?.map((x) => x.toJson()) ?? [],
    ),
  };
}

class FeeStudentInfo {
  FeeStudentInfo({this.id, this.fullName});

  int? id;
  String? fullName;

  factory FeeStudentInfo.fromJson(Map<String, dynamic> json) =>
      FeeStudentInfo(id: json["id"], fullName: json["full_name"]);

  Map<String, dynamic> toJson() => {"id": id, "full_name": fullName};
}

class TranscationDetail {
  TranscationDetail({this.paidAmount});

  double? paidAmount;

  factory TranscationDetail.fromJson(Map<String, dynamic> json) =>
      TranscationDetail(paidAmount: json["paid_amount"].toDouble());

  Map<String, dynamic> toJson() => {"paid_amount": paidAmount};
}
