...
class StudentAddPaymentModel {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "bankAccounts": List<dynamic>.from(
      bankAccounts?.map((x) => x.toJson()) ?? [],
    ),
    "invoiceInfo": invoiceInfo?.toJson(),
    "invoiceDetails": List<dynamic>.from(
      invoiceDetails?.map((x) => x.toJson()) ?? [],
    ),
...
class BankAccount {
  BankAccount({this.id, this.bankName, this.accountNumber});
...
class StudentInfo {
  StudentInfo({this.id, this.user});
  int? id;
  User? user;

  factory StudentInfo.fromJson(Map<String, dynamic> json) =>
      StudentInfo(id: json["id"], user: User.fromJson(json["user"]));
...
class FeesPaymentMethod {
  FeesPaymentMethod({this.paymentMethod});

  String? paymentMethod;

  factory FeesPaymentMethod.fromJson(Map<String, dynamic> json) =>
      FeesPaymentMethod(paymentMethod: json["payment_method"]);
