...
class FeeWaiverReportModel {
  FeeWaiverReportModel({this.waiverReport, this.totalWaiver});
  ...
  factory FeeWaiverReportModel.fromJson(Map<String, dynamic> json) =>
      FeeWaiverReportModel(
        waiverReport: Map.from(json["waiverReport"]).map(
          (k, v) => MapEntry<String, WaiverReport>(k, WaiverReport.fromJson(v)),
        ),
        totalWaiver: json["totalWaiver"],
      );

  Map<String, dynamic> toJson() => {
    "waiverReport": Map.from(
      waiverReport ?? {},
