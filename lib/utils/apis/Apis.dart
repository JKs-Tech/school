...
class InfixApi {
  ...
  static String rootNew = '${AppConfig.domainNameNew}/';

  static String baseApiNew = isStudent() ? '${rootNew}api/' : "";
  ...
  static String getCreatePaymentUrl() {
    return 'webservice/create_payment';
  }
  ...
  static String getMyNotifications(dynamic id) {
    return "$baseApiNew/webservice/getNotifications";
  }
  ...
  static String studentFeePayment(
    String stuId,
    dynamic feesType,
    String amount,
    String paidBy,
  ...
  static String getStudentExamSchedule(var id) {
  ...
  static String getStudenthomeWorksUrl() {
    return "webservice/getHomework";
  }

  static String getStudentTeacherListUrl() {
    return "webservice/getTeachersList";
  }

  static String getStaffUrl() {
    return "webservice/addStaffRating";
  }
  ...
  static String getHostelListUrl() {
    return "webservice/getHostelList";
  }

  static String getHostelDetailsUrl() {
    return "webservice/getHostelDetails";
  }

  static String getComplaintListUrl() {
    return "webservice/getComplaint";
  }

  static String getAddComplaintUrl() {
    return "webservice/AddComplaint";
  }

  static String getApplyLeaveListUrl() {
    return "webservice/getApplyLeave";
  }

  static String getAddLeaveUrl() {
    return "webservice/addleave";
  }

  static String deleteLeaveUrl() {
    return "webservice/deleteLeave";
  }

  static String updateLeaveUrl() {
    return "webservice/updateLeave";
  }

  static String getSyllabusSubjectsUrl() {
    return "webservice/getsyllabussubjects";
  }

  static String getSyllabusLessonUrl() {
    return "webservice/getSubjectsLessons";
  }

  static String getExamListUrl() {
    return "webservice/getExamList";
  }

  static String getExamScheduleUrl() {
    return "webservice/getExamSchedule";
  }

  static String getExamResultUrl() {
    return "webservice/getExamResult";
  }

  static String getDocumentUrl() {
    return "webservice/getDocument";
  }
  ...
  static String getLiveClassesUrl() {
    return "webservice/liveclasses";
  }

  static String getLiveHistoryUrl() {
    return "webservice/livehistory";
  }

  static String getLibraryBookIssuedUrl() {
    return "webservice/getLibraryBookIssued";
  }

  static String getLibraryBooksUrl() {
    return "webservice/getLibraryBooks";
  }

  static String getClassScheduleUrl() {
    return "webservice/class_schedule";
  }

  static String getSyllabusUrl() {
    return "webservice/getsyllabus";
  }

  static String getSyllabusItemUrl() {
    return "webservice/getsyllabusitem";
  }

  static String getOnlineExamUrl() {
    return "webservice/getOnlineExam";
  }

  static String getOnlineExamQuestionUrl() {
    return "webservice/getOnlineExamQuestion";
  }

  static String saveOnlineExamUrl() {
    return "webservice/saveOnlineExam";
  }

  static String getOnlineExamResultUrl() {
    return "webservice/getOnlineExamResult";
  }

  static String getDownloadsLinksUrl() {
    return "webservice/getDownloadsLinks";
  }

  static String getAttendenceRecordsUrl() {
    return "webservice/getAttendenceRecords";
  }

  static String getTransportRouteUrl() {
    return "webservice/getTransportRoute";
  }

  static String getTransportVehicleDetailsUrl() {
    return "webservice/getTransportVehicleDetails";
  }

  static String getVerifyParentTelNumberUrl() {
    return "webservice/verifyParentTelNumber";
  }

  static String getUpdateChildAbsentUrl() {
    return "webservice/updateChildAbsent";
  }

  static String setZoneAlertDistanceUrl() {
    return "webservice/setZoneAlertDistance";
  }

  static String updatePositionUrl() {
    return "webservice/updatePosition";
  }

  static String studentchatusersUrl() {
    return "webservice/studentchatusers";
  }

  static String addTeacherToChatUrl() {
    return "webservice/AddTeacher_to_chat";
  }

  static String getChatMessageUrl() {
    return "webservice/getMessage";
  }

  static String newMessageUrl() {
    return "webservice/newMessage";
  }

  static String getUploadHomeUrl() {
    return "/webservice/addaa";
  }

  static String getParentStudentUrl() {
  ...
  static Future<String> getApiUrl() async {
    return await Utils.getStringValue('apiUrl') ?? baseApiNew;
  }

  static Future<String> getImageUrl() async {
    return await Utils.getStringValue('imageUrl') ?? rootNew;
  }
}
