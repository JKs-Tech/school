...
class ProfileService {
  ...
  Future<List<InfixMap>> fetchPersonalServices(int index) async {
    ...
    final response = await http.get(
      Uri.parse(InfixApi.getChildren(id)),
    ...
    switch (index) {
      case 0:
        ...
        infixMap.add(InfixMap('Age', ' years'));
        infixMap.add(
        ...
        infixMap.add(
          InfixMap('Permanent address', details['permanent_address']),
        );
        infixMap.add(
          InfixMap('Blood group', blood != null ? blood['name'] : null),
        );
        break;
      case 1:
        details['fathers_photo'] != null
            ? infixMap.add(
              InfixMap('Fathers\'s Photo', details['fathers_photo']),
            )
            : infixMap.add(
              InfixMap('Fathers\'s Photo', "https://i.imgur.com/7PqjiH7.jpg"),
            );
        ...
        details['mothers_photo'] != null
            ? infixMap.add(
              InfixMap('Mothers\'s Photo', details['mothers_photo']),
            )
            : infixMap.add(
              InfixMap('Mothers\'s Photo', "https://i.imgur.com/7PqjiH7.jpg"),
            );
        ...
        details['guardians_photo'] != null
            ? infixMap.add(
              InfixMap('Guardians\'s Photo', details['guardians_photo']),
            )
            : infixMap.add(
              InfixMap('Guardians\'s Photo', "https://i.imgur.com/7PqjiH7.jpg"),
            );
        ...
        infixMap.add(
          InfixMap('Guardian\'s occupation', details['guardians_occupation']),
        );
        infixMap.add(
          InfixMap('Guardian\'s phone', details['guardians_mobile']),
        );
        infixMap.add(
