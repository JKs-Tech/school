...
ThemeData basicTheme() {
  TextTheme basicTextTheme(TextTheme base) {
    return base.copyWith(
      ...
      bodySmall: GoogleFonts.poppins(
        textStyle: base.bodySmall?.copyWith(color: const Color(0xFFCCC5AF)),
      ),
      bodyMedium: GoogleFonts.poppins(
        textStyle: base.bodyMedium?.copyWith(color: const Color(0xFF807A6B)),
      ),
    );
  }
  ...
  return base.copyWith(
    ...
    cardTheme: CardThemeData(color: Colors.white, margin: EdgeInsets.all(10.0)),
