...
class OrderSheet extends StatelessWidget {
  ...
  Widget _titleLarge(context) => Row(
    mainAxisAlignment: MainAxisAlignment.start,
    children: <Widget>[
      IconButton(
        onPressed: () {
...
class _ShippingInformation extends StatelessWidget {
  final String email;
  const _ShippingInformation({required this.email});
  @override
...
class _LineDivider extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: const Divider(height: 1, color: Colors.deepPurpleAccent),
  );
}
