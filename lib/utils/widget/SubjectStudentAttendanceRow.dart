        ...
        ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              ...
              CustomRadioButton(
                defaultSelected:
                    attendanceStudents.attendanceType == null
                        ? "P"
                ...
                buttonLables: const ['Present', 'Late', 'Absent', 'Half Day'],
                buttonValues: const ["P", "L", "A", "F"],
                  ...
                  setState(() {
                    ...
                    _attendanceController.attendanceMap.update(
                      ...
                      (value) => SubjectAttendanceValue(
                        ...
                        section: attendanceStudents.sectionId.toString(),
                        subject: attendanceStudents.subjectId.toString(),
                        attendanceClass: attendanceStudents.classId.toString(),
