...
class _ClassRoutineState extends State<RoutineRow> {
  ...
  dynamic classCode;
  dynamic sectionCode;
  late Future<ScheduleList> routine;
  late String _token;
    ...
    return Padding(
      ...
      child: FutureBuilder<ScheduleList>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            if (snapshot.data != null && snapshot.data!.schedules.isNotEmpty) {
              return Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Container(
                      height: 0.5,
                      decoration: const BoxDecoration(color: Color(0xFF415094)),
                    ),
                  ),
                ],
              );
  ...
  Future<ScheduleList> fetchRoutine(dynamic id, String title) async {
    final response = await http.get(
      Uri.parse(InfixApi.getRoutineUrl(id)),
