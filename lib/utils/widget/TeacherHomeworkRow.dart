...
class _TeacherHomeworkRowState extends State<TeacherHomeworkRow> {
        ...
        child: InkWell(
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder:
                    (context) => HomeworkEvaluationScreen(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const SizedBox(height: 10.0),
                          Text(
                            widget.homework.submitDate ?? 'not assigned',
                            maxLines: 1,
                            style: Theme.of(context).textTheme.headlineMedium,
                          ),
                        ],
  ...
  showDownloadAlertDialog(BuildContext context, String title) {
    ...
    Widget yesButton = TextButton(
      ...
      onPressed: () {
        teacherUpload != null
            ? downloadFile(teacherUpload ?? "", context, title)
    ...
    AlertDialog alert = AlertDialog(
      title: Text("Download", style: Theme.of(context).textTheme.headlineSmall),
